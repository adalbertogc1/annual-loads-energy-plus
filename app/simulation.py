...
def run_simulation(target_folder, user_id, hb_model, epw_path, ddy_path, north):
    ...
    button_holder2.download_button(label="Download HB Json",data=json.dumps(st.session_state.hb_model.to_dict()),file_name=f"HBmodel_{dt}.json",mime="application/json")
