...
def geometry_parameters(container):
    ...
    width_ = container.number_input("Building Width [m]",min_value=0.0,max_value=50.0,value=10.0,step= 1.0,help="This is the width of the building in meters")
    lenght_ = container.number_input("Building Lenght [m]",min_value=0.0,max_value=50.0,value=20.0,step= 1.0,help="This is the lenght of the building in meters", )        
